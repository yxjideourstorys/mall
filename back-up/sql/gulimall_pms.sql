...
CREATE TABLE `pms_attr` (
  ...
  `attr_name` char(30) COLLATE utf8_bin DEFAULT NULL COMMENT '属性名',
  `search_type` tinyint(4) DEFAULT NULL COMMENT '是否需要检索[0-不需要，1-需要]',
  `icon` varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT '属性图标',
  `value_select` char(255) COLLATE utf8_bin DEFAULT NULL COMMENT '可选值列表[用逗号分隔]',
  ...
  `value_type` tinyint(4) DEFAULT NULL COMMENT '值类型【0只能单个值，1允许多个值】',
  PRIMARY KEY (`attr_id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='商品属性';
